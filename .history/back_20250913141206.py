...
# SOLUZIONE: Migliorare il metodo leggi_quantita_da_word per leggere TUTTO
    ...
    def calcola_quantita(self, key, referenze_cibo, num_pers, servizio_lower, tipo_ap):
        ...
        if "aperitivo" in servizio_lower and not is_aperitivo_rinforzato and key not in self.referenze_primi:
            # Logiche speciali per aperitivo leggero (logica originale)
        ...
        if key in self.referenze_contorni:
            if use_dynamic_balancing:
                peso_contorni_per_persona = 0.050  # 50g invece di 80g per lunch/aperitivo rinforzato
...
# ==============================================================================
    ...
    def _calcola_aperitivo_originale(self, key, referenze_cibo, num_pers, servizio_lower, tipo_ap):
        """Logica originale per aperitivo leggero"""
        voce = self.voce_originale.get(key, key).strip()
    ...
    def _calcola_finger_food_con_bilanciamento(self, key, referenze_cibo, num_pers, servizio_lower, tipo_ap, peso_unitario, bilanciamento):
        ...
        is_lunch = "lunch" in servizio_lower or "pranzo" in servizio_lower
        is_aperitivo_rinforzato = "aperitivo" in servizio_lower and tipo_ap == "rinforzato"
        use_balancing = is_lunch or is_aperitivo_rinforzato
        ...
        if use_balancing:
            ...
            # LOGICA SERVITO: 200g per persona distribuiti tra finger food
    ...
    def calcola_quantita_menu_extra_dolci_aperitivo_rinforzato(self, voce, persone):
        ...
        # Se è aperitivo rinforzato, i dolci sono 3 per persona
